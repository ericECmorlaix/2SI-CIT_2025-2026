...
- **Développer** en équipe tout au long de l'année des projets...
    ...
    - Construire et programmer des robots, par exmple pour [RoboFesta](https://www.robofesta.fr){target="_blank"} ;
    - Hacker un système pour le comprendre et le faire évoluer, par exemple un pilote automatique de barre franche, une maquette d'ascenceur, le [robot artiste dessinateur Quincy](https://france-tendance.com/products/quincy%E2%84%A2-robot-artiste-dessinateur){target="_blank"}, ... ;    
    - Développer des équipements d'IoT (Internet des Objets) et de domotique, par exemple pour connecter la serre du projet "planète verte" au collège Saint Augustin, faire une station météo, ... ;
...
=== "CONTENU DE SÉANCE"
    ...
    - **Préparer** une présentation bilan de vos réalisations en projets, les **documenter** sur [Capytale n°0fdc-7711653](https://capytale2.ac-paris.fr/web/c/0fdc-7711653){target="_blank"} et transmettre une copie de vos notebook à Maël pour publication...
        
    > [Importante ressource pour la programmation en MicroPython](http://www.multiwingspan.co.uk/micro.php?page=first){target="_blank"}...   
...
=== "CONTENU DE SÉANCE"
    ...
    - **Finaliser** vos pré-projets, les **documenter** sur [Capytale n°0fdc-7711653](https://capytale2.ac-paris.fr/web/c/0fdc-7711653){target="_blank"} et transmettre une copie de vos notebook à Maël pour publication :
        ...
        - **Hugo/Laïn** : Exploiter l'information d'une boussole sur BBC micro:bit dans la perspective de piloter une barre franche de bateau.
        - **Robin/Adrien** : Organiser un réseau de cartes BBC micro:bit afin de sécuriser la transmission de messages chiffrés.
        - **Jules/Alexis** : Produire du son avec une BBC microbit pour jouer les titres d'une playlist.
        - **Tino/Lancelot** : Numériser le signal analogique d'un potentiomètre en entrée d'une carte BBC micro:bit pour amplifier une sortie.
        - **Yanis/Alexandre** : Piloter un robot roulant avec une télécommande infrarouge.
        
    - **Envisager** un prolongement de vos projets pour ce dernier trimestre réalisable en maximum sept séances ;
...
=== "CONTENU DE SÉANCE"
    ...
    - Reprendre vos pré-projets sur BBC micro:bit :
...
=== "CONTENU DE SÉANCE"
    ...
    - **Initier** un pré-projet sur BBC micro:bit :
...
=== "CONTENU DE SÉANCE"
    ...
    - Retour sur la fiche d'informations, bilan de la Fête de la science et **pistes de futurs projets** sur [Capytale n°0fdc-7711653](https://capytale2.ac-paris.fr/web/c/0fdc-7711653){target="_blank"} ;
